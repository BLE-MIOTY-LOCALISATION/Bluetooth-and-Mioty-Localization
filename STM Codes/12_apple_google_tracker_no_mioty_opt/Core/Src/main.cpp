...
void SX1280_SendAppleBeacon(void)
{
    ...
    uint8_t adv_data[31] = {
        ...
        // 22 bytes of pubkey payload generated by macless-haystack
        0x4c, 0xfb, 0x24, 0x77, 0xca, 0x5f, 0xa5, 0x34, 0x8a, 0xf1, 0x89, 
        0xfa, 0x9b, 0x14, 0x8e, 0xd2, 0xca, 0x4b, 0xd0, 0x13, 0x5e, 0x6a,
        0x02, // first two bits of pubkey[0] (0x9C >> 6 = 2)
        0x00  // hint byte
    };

    // MAC Address generated by macless-haystack
    // Must be sent LSB-first. The MSB (public_key[0] | 0xC0) must be mac[5].
    // Original public_key[0:5]: 0x9c, 0x84, 0xb8, 0xba, 0x01, 0x34
    // So mac[5] = 0x9c | 0xC0 = 0xDC
    uint8_t mac[6] = {0x34, 0x01, 0xba, 0xb8, 0x84, 0xDC};
